...
NAME = "ZenPacks.CS.NetApp.SevenMode"
VERSION = "1.0.0"
AUTHOR = "htolic"
LICENSE = "GPLv2"
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.CS', 'ZenPacks.CS.NetApp']
PACKAGES = ['ZenPacks', 'ZenPacks.CS', 'ZenPacks.CS.NetApp', 'ZenPacks.CS.NetApp.SevenMode']
INSTALL_REQUIRES = ['ZenPacks.zenoss.PythonCollector>=1.10.1']
